...
upstream_pin:    927f5d53caf8111721e734cf24724686bb745f55  # tag: 2025-11-05
...
allocator:       custom              # C++ RAII: new/delete via std::unique_ptr facade
...
proof_invariants: [
  "opaque handle is non-null after successful construction",
  "invalid patterns return error without leaking handle ownership",
  "Drop/free is called exactly once per owned handle",
  "partial_match never reads beyond bounded input slices"
]
```
